...
class Config {
    constructor() {
        ...
        if (error) {
             ...
             */
            if (((_a = error.details[0].context) === null || _a === void 0 ? void 0 : _a.key) != "VERCEL_API_BUILD_CONTAINERS_ENDPOINT" && ((_b = error.details[0].context) === null || _b === void 0 ? void 0 : _b.key) != "ALLUSERSPROFILE") {
