...
const entities_5 = require("../features/stats_user/entities");
...
class Config {
    constructor() {
        ...
        if (error) {
             ...
             */
            if (((_a = error.details[0].context) === null || _a === void 0 ? void 0 : _a.key) != "VERCEL_API_BUILD_CONTAINERS_ENDPOINT" && ((_b = error.details[0].context) === null || _b === void 0 ? void 0 : _b.key) != "VERCEL_GIT_COMMIT_AUTHOR_NAME" && ((_c = error.details[0].context) === null || _c === void 0 ? void 0 : _c.key) != "ALLUSERSPROFILE") {
        ...
        this.dbConfig = {
            ...
            entities: [entities_1.Quiz, entities_3.Event, entities_2.User, entities_4.StatsEvent, entities_5.StatsUser]
        };
        this.server = {
            port: envVars.PORT,
            host: envVars.HOST
