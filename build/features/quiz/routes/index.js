...
class QuizRoute extends route_base_1.default {
    constructor(app) {
         ...
         */
        this.route.get("", this.validator(validations_1.getQuestionnaireScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.getQuizForSinglePlayer);
        /**
         ...
         */
        this.route.get("/allThematics", [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.getAllRubrics);
    }
    init() {
