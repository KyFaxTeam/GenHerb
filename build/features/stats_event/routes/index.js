...
class StatsEventRoute extends route_base_1.default {
    constructor(app) {
         ...
         */
        this.route.get("", this.validator(validations_1.getStatsWithIdScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.getStatWithEventId);
        // Player post his stats after he was played
        this.route.post("", this.validator(validations_1.playerPostStatsEventScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.postStats);
        // 
        this.route.get("/my_stats", this.validator(validations_1.playerGetOwnStats), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.getOwnStats);
    }
    init() {
