...
class ArticleRoute extends route_base_1.default {
    constructor(app) {
        ...
        this.route.get("/status/:status", this.validator(validations_1.getActiveEventScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.eventByStatus);
        // * 2 - GET request to retrieve quiz of a event
        this.route.get("/start", this.validator(validations_1.EventWithIdScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.eventStartToPlay);
        // * 3 - GET request to retrieve one event with his id
        this.route.get("", this.validator(validations_1.EventWithIdScheme), [auth_1.authenticateUser], [auth_1.verifyOwnership], this.controller.eventWithId);
