...
//   })
  ...
  updateUser = this.catchAsync(async (req: RequestwithUser, res: Response) => {
  ...
  deactivateUser = this.catchAsync(async (req: RequestwithUser, res: Response) => {
  ...
  markEmailVerified = this.catchAsync(async (req: RequestwithUser, res: Response) => {
