...
export default class AuthRoute extends BaseRoute {
    ...
    public constructor(app: express.Application) {
        ...
        this.route.post('/refresh-token', this.validator(null), [authenticateUser] as any, this.controller.refreshToken)
        this.route.post('/logout/', this.validator(null), [authenticateUser] as any, [verifyOwnership] as any, this.controller.logout)
